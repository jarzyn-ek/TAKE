...
public class LoginBean {
    ...
    public String login() {
        ...
        if (username.equals("scott") && password.equals("tiger")) {
            ...
            String message = context.getApplication().evaluateExpressionGet(context, "#{AppMessages['validation.notoracle']}", String.class);
            context.addMessage(getForm().getClientId(context),
